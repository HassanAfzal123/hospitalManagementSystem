...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`USER_INFO` (
  ...
  INDEX `fk_USER_INFO_USER_ROLE1_idx` (`USER_ROLE_role_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`PATIENT` (
  ...
  INDEX `fk_PATIENT_USER_INFO_idx` (`USER_INFO_info_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`STAFF` (
  ...
  UNIQUE INDEX `cnic_no_UNIQUE` (`cnic_no` ASC) VISIBLE,
  UNIQUE INDEX `staff_id_UNIQUE` (`staff_id` ASC) VISIBLE,
  INDEX `fk_STAFF_USER_INFO1_idx` (`USER_INFO_info_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`ADMIN` (
  ...
  INDEX `fk_ADMIN_USER_INFO1_idx` (`USER_INFO_info_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`DISEASE` (
  ...
  UNIQUE INDEX `disease_id_UNIQUE` (`disease_id` ASC) VISIBLE,
  UNIQUE INDEX `name_UNIQUE` (`name` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`LABORTORY_REPORT` (
  ...
  UNIQUE INDEX `stored_path_UNIQUE` (`stored_path` ASC) VISIBLE,
  INDEX `fk_LABORTORY_REPORT_PATIENT1_idx` (`PATIENT_patient_id` ASC) VISIBLE,
  INDEX `fk_LABORTORY_REPORT_STAFF1_idx` (`STAFF_staff_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`BLOOD_DONOR` (
  ...
  INDEX `fk_BLOOD_DONOR_STAFF1_idx` (`STAFF_staff_id` ASC) VISIBLE,
  CONSTRAINT `fk_BLOOD_DONOR_STAFF1`
    FOREIGN KEY (`STAFF_staff_id`)
    REFERENCES `HMS_ERD`.`STAFF` (`staff_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`BLOOD_REQUEST` (
  ...
  UNIQUE INDEX `blood_request_id_UNIQUE` (`blood_request_id` ASC) VISIBLE,
  INDEX `fk_BLOOD_REQUEST_PATIENT1_idx` (`PATIENT_patient_id` ASC) VISIBLE,
  INDEX `fk_BLOOD_REQUEST_BLOOD_DONOR1_idx` (`BLOOD_DONOR_donor_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`ZAKAAT_REQUEST` (
  ...
  UNIQUE INDEX `zakaat_request_id_UNIQUE` (`zakaat_request_id` ASC) VISIBLE,
  INDEX `fk_ZAKAAT_REQUEST_PATIENT1_idx` (`PATIENT_patient_id` ASC) VISIBLE,
  INDEX `fk_ZAKAAT_REQUEST_ZAKAAT_DONOR1_idx` (`ZAKAAT_DONOR_zakaat_donor_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`APPOINTMENT` (
  ...
  `PATIENT_patient_id` INT NOT NULL,
  `Status` VARCHAR(45) CHARACTER SET 'ascii' NULL,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`ANSWER` (
  ...
  UNIQUE INDEX `ANSWER_UNIQUE` (`answer_id` ASC) VISIBLE,
  UNIQUE INDEX `response_UNIQUE` (`response` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`ASKED_QUESTIONS` (
  ...
  INDEX `fk_ASKED_QUESTIONS_ANSWER1_idx` (`ANSWER_answer_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`HOME_SERVICE` (
  ...
  UNIQUE INDEX `home_service_id_UNIQUE` (`home_service_id` ASC) VISIBLE,
  INDEX `fk_HOME_SERVICE_PATIENT1_idx` (`PATIENT_patient_id` ASC) VISIBLE,
  INDEX `fk_HOME_SERVICE_STAFF1_idx` (`STAFF_staff_id` ASC) VISIBLE,
  INDEX `fk_HOME_SERVICE_DOCTOR1_idx` (`DOCTOR_doctor_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`PATIENT_has_DISEASE` (
  ...
  INDEX `fk_PATIENT_has_DISEASE_DISEASE1_idx` (`DISEASE_disease_id` ASC) VISIBLE,
  INDEX `fk_PATIENT_has_DISEASE_PATIENT1_idx` (`PATIENT_patient_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`PATIENT_has_DOCTOR` (
  ...
  INDEX `fk_PATIENT_has_DOCTOR_DOCTOR1_idx` (`DOCTOR_doctor_id` ASC) VISIBLE,
  INDEX `fk_PATIENT_has_DOCTOR_PATIENT1_idx` (`PATIENT_patient_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`BED` (
  ...
  INDEX `fk_BED_WARDS1_idx` (`WARDS_ward_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`DOCTOR_DISEASE` (
  ...
  INDEX `fk_DISEASE_has_DOCTOR_DOCTOR1_idx` (`DOCTOR_doctor_id` ASC) VISIBLE,
  INDEX `fk_DISEASE_has_DOCTOR_DISEASE1_idx` (`DISEASE_disease_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `HMS_ERD`.`PATIENT_wasin_BED` (
  ...
  INDEX `fk_PATIENT_has_BED_BED1_idx` (`BED_bed_id` ASC) VISIBLE,
  INDEX `fk_PATIENT_has_BED_PATIENT1_idx` (`PATIENT_patient_id` ASC) VISIBLE,
